...
const Navbar = () => {
  ...
  return (
    <div className="navbar">
      <h3 onClick={()=>navigate('/')} style={{color:"gray"}}><b>HR</b><sub>streaming</sub></h3>
      <div className="nav-content">
        ...
        :
           ...
           <button onClick={()=>navigate('/authenticate')} style={{backgroundColor:"gray",color:"white",border:"2px solid white"}}>Sign In</button>
